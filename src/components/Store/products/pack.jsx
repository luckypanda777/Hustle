...
import PackPlaceHolder from "../../../assets/images/shop/pack-placeholder.png";
...
class ProductPack extends Component {
  state = {};
  render() {
    return (
      <div className="flex flex-col items-center justify-center p-5 md:gap-y-1">
        ...
        <div className="flex flex-col items-center">
          <img className="w-38" src={PackPlaceHolder} alt="hustle" />
        </div>
