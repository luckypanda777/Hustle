        ...
        <div className="max-w-sm cursor-pointer  rounded-lg border border-gray-200 bg-olive shadow-md dark:border-gray-700 dark:bg-gray-800">
          ...
          <div className="p-5">
            ...
            <div className="mt-5 flex items-center justify-between">
              ...
              <Link
                to={`/item/${id}`}
                className="inline-flex items-center rounded-lg bg-teal-700 py-2 px-3 text-center text-sm font-medium text-white hover:bg-teal-800 focus:outline-none focus:ring-4 focus:ring-teal-300 dark:bg-teal-600 dark:hover:bg-teal-700 dark:focus:ring-teal-800"
              >
                View Asset
              </Link>
            </div>
