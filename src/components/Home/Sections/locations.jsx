...
class Locations extends Component {
  ...
  render() {
    return (
      <div className="flex w-full flex-col items-center justify-center gap-y-5 py-16 px-5 md:px-10 md:py-24 lg:flex-row">
        <div className="flex w-full flex-row items-center justify-center gap-x-1 lg:w-2/3 lg:items-end">
          <img
        ...
        <div className="flex w-full flex-col gap-y-5 md:p-5 lg:w-1/2">
