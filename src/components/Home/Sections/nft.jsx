...
class NFT extends Component {
  render() {
    return (
      <div className="flex w-full flex-col items-center justify-center gap-x-1 py-16 md:flex-row md:px-5 md:py-24 md:px-10">
        ...
        <div className="flex w-full flex-col gap-y-5 p-5 md:w-1/2">
          <h2 className="text-3xl font-bold text-primary md:text-5xl">NFT's</h2>
